 ...
 */
public class GetProfileListener extends HTTPListener {
    ...
    protected String getKeyCache() {
        return AppUserPreference.KEY_RESPONSE_GET_PROFILE;
    }
    ...
    public Request<?> getStringRequest() {
        ...
        return new JsonObjectRequest(Request.Method.POST, HTTPUrl.HOST + HTTPUrl.PARAM_GET_PROFILE, jsonObject,
    ...
    protected void onGetResponse(JSONObject response) throws JSONException {
        ...
        if(onHTTPListener != null)
            onHTTPListener.onGetResponse(profileModel);
    }
